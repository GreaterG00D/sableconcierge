          ...
          <div className="overflow-hidden rounded-[32px] border border-[rgba(166,140,74,0.42)] bg-[linear-gradient(180deg,#f8f3ea_0%,#f2ebdf_100%)] px-5 py-12 sm:px-8 sm:py-16 xl:px-12 xl:py-20">
            <div className="mb-10 text-center sm:mb-12 xl:mb-14">
              ...
              <p className="mx-auto mt-4 max-w-[42rem] text-[1.02rem] leading-[1.7] italic text-[var(--sable-sage)] sm:text-[1.14rem] xl:text-[1.22rem]">
                A personalized membership designed around the way you live.
              </p>
            </div>
            ...
            <div className="relative hidden xl:block">
              ...
              <div className="relative z-10 grid min-h-[580px] grid-cols-2">
                <div className="rounded-l-[42px] border border-r-0 border-[rgba(166,140,74,0.22)] bg-[linear-gradient(180deg,#22311a_0%,#2d3e23_100%)] px-14 py-14 transition duration-500 hover:-translate-y-1 2xl:px-16 2xl:py-16">
                ...
                <div className="rounded-r-[42px] border border-l-0 border-[rgba(166,140,74,0.22)] bg-[linear-gradient(180deg,#44563a_0%,#56694a_100%)] px-14 py-14 transition duration-500 hover:-translate-y-1 2xl:px-16 2xl:py-16">
